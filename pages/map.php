...
<div class="container maps-page" style="max-width:1180px;margin:auto;">
    ...
    <p class="page-subtitle muted reveal" style="margin-top:4px;margin-bottom:12px;">Pins show active courts. Click a pin to open the court and book a slot.</p>
    <div class="map-browse-wrap reveal" style="margin-top:-8px;">
